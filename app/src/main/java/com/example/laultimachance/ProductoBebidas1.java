...
public class ProductoBebidas1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("Products").child("Cafe Ole").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    ole = snapshot.child("Image").getValue().toString();
                    Glide.with(ProductoBebidas1.this).load(ole).into(sImgProducto);
